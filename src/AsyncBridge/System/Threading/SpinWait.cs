    ...
    public struct SpinWait
    {
        ...
        internal void SpinOnce(int sleep1Threshold)
        {
            ...
            else
            {
                ...
                // AsyncBridge edit: using previous implementation from https://github.com/dotnet/coreclr/blob/12db0a3ccf42ab21333872cc3984009aecd06eeb/src/mscorlib/shared/System/Threading/SpinWait.cs
