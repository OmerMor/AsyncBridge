// https://github.com/dotnet/coreclr/blob/v2.1.0/src/mscorlib/src/System/Threading/CancellationTokenSource.cs
    ...
    public class CancellationTokenSource : IDisposable
    {
            ...
            Action<object> callback, object stateForCallback, SynchronizationContext syncContext, ExecutionContext executionContext)
        {
            ...
            if (!IsCancellationRequested)
            {
                ...
                int partitionIndex = Thread.CurrentThread.ManagedThreadId & s_numPartitionsMask;
