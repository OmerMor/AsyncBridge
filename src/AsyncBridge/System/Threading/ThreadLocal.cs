// https://github.com/dotnet/coreclr/blob/v2.1.0/src/mscorlib/src/System/Threading/ThreadLocal.cs
...
#region IDisposable Members
        ...
        {
            if ((uint)minSize > ArrayEx.MaxArrayLength)
            {
            ...
            if ((uint)newSize > ArrayEx.MaxArrayLength)
            {
                newSize = ArrayEx.MaxArrayLength;
            }
