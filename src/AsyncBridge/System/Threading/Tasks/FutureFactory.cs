// https://github.com/dotnet/coreclr/blob/v2.1.0/src/mscorlib/src/System/Threading/Tasks/FutureFactory.cs
    ...
    public class TaskFactory<TResult>
    {
            ...
            bool requiresSynchronization)
        {
            ...
            finally
            {
                if (oce != null)
                {
                    promise.TrySetCanceled(oce.GetCancellationToken(), oce);
                }
                else if (ex != null)
                {
        ...
        private sealed class FromAsyncTrimPromise<TInstance> : Task<TResult> where TInstance : class
        {
                ...
                bool requiresSynchronization)
            {
                ...
                {
                    successfullySet = TrySetCanceled(oce.GetCancellationToken(), oce);
                }
                catch (Exception exc)
                {
