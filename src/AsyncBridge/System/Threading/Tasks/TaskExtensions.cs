...
namespace System.Threading.Tasks
{
    ...
    public static class TaskExtensions
    {
        ...
        /// <summary>Creates a proxy <see cref="Task{TResult}"/> that represents the asynchronous operation of a <see cref="Task{T}"/> whose result is a <see cref="Task{TResult}"/>..</summary>
        /// <param name="task">The <see cref="Task{T}"/> to unwrap whose result is a <see cref="Task{TResult}"/>.</param>
        /// <returns>A <see cref="Task{TResult}"/> that represents the asynchronous operation of the provided <see cref="Task{T}"/> whose result is a <see cref="Task{TResult}"/>.</returns>
