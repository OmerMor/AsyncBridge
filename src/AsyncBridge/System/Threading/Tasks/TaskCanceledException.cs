// https://github.com/dotnet/coreclr/blob/v2.1.0/src/mscorlib/shared/System/Threading/Tasks/TaskCanceledException.cs
...
namespace System.Threading.Tasks
{
    ...
    public class TaskCanceledException : OperationCanceledException
    {
        ...
        public TaskCanceledException(string message, Exception innerException, CancellationToken token) : base(message, innerException)
        {
        }
