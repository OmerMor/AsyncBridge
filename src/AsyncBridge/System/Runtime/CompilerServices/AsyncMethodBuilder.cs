// https://github.com/dotnet/coreclr/blob/v2.1.0/src/mscorlib/src/System/Runtime/CompilerServices/AsyncMethodBuilder.cs
    ...
    public struct AsyncTaskMethodBuilder<TResult>
    {
            ...
            where TStateMachine : IAsyncStateMachine
        {
            ...
            if (m_task is AsyncStateMachineBox<IAsyncStateMachine> weaklyTypedBox)
            {
                ...
                {
                    DebuggerEx.NotifyOfCrossThreadDependency(); // same explanation as with usage below
        ...
        public void SetException(Exception exception)
        {
            ...
            bool successfullySet = oce != null ?
                task.TrySetCanceled(oce.GetCancellationToken(), oce) :
        ...
        public static void Start<TStateMachine>(ref TStateMachine stateMachine) where TStateMachine : IAsyncStateMachine
        {
            ...
            finally
            {
                ...
                if (previousExecutionCtx != currentExecutionCtx)
                {
                    ...
                    currentThread.SetExecutionContext(previousExecutionCtx);
                }
            }
        }
